...
extern const u8 BattleScript_SynchronizedSwimActivates[];
extern const u8 BattleScript_ChrysalisHeal[];
extern const u8 BattleScript_ResearchDefensesUp[];
extern const u8 BattleScript_ResearchOffensesUp[];
extern const u8 BattleScript_StuntDoubleExplosion[];
extern const u8 BattleScript_EffectResearch[];
extern const u8 BattleScript_EffectCastingCall[];
extern const u8 BattleScript_EffectMountingPressure[];
extern const u8 BattleScript_EffectStuntDouble[];
...
extern const u8 BattleScript_AttackWeakenedByWindstorm[];
...
extern const u8 BattleScript_AuraFarmingFaint[];
...
extern const u8 BattleScript_EffectIceRink[];
extern const u8 BattleScript_IceRinkOnSwitchIn[];
extern const u8 BattleScript_IceRinkMelted[];
extern const u8 BattleScript_EffectInversion[];
extern const u8 BattleScript_EffectShowstopper[];
extern const u8 BattleScript_ShowstopperStatDrop[];
...
extern const u8 BattleScript_OverexposureMessage[];
