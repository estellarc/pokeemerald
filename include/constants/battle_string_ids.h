...
enum StringID
{
    ...
    STRINGID_WINDSTORMSTARTED,
    STRINGID_WINDSTORMRAGES,
    STRINGID_WINDSTORMSUBSIDED,
    STRINGID_ATTACKWEAKENEDBYWINDSTORM,
    ...
    STRINGID_PKMNBECAMEWEAKERTOICE,
    ...
    STRINGID_ICERINKSET,
    STRINGID_PKMNSLIDONICE,
    STRINGID_ICERINKMELTED,
    ...
    STRINGID_TYPECHARTINVERTED,
    STRINGID_TYPECHARTRESTORED,
    STRINGID_PKMNWASCHARGEDWITHPOWER,
    STRINGID_COUNT
};
...
// gInversionStringIds
enum InversionStringID
{
    B_MSG_INVERSION_STARTED,
    B_MSG_INVERSION_ENDED,
};
