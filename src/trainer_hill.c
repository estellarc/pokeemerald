...
static const u16 sPrizeListRoar[]        = {ITEM_TM_PSYCHE_LOCK,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListToxic[]       = {ITEM_TM_POISONED_STARS,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
