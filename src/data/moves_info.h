...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_POUND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pound", "Destructor"),
        .description = COMPOUND_STRING(
            "Pounds the foe with\n"
            "forelegs or tail."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_KARATE_CHOP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Karate Chop", "Golpe Kárate"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Slap", "Doble Bofetón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COMET_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Comet Punch", "Puño Cometa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEGA_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mega Punch", "Megapuño"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PAY_DAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pay Day", "Día de Pago"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Punch", "Puño Fuego"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Punch", "Puño Hielo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder Punch", "Puño Trueno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCRATCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Scratch", "Arañazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VISE_GRIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Vise Grip", "Agarre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUILLOTINE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Guillotine", "Guillotina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAZOR_WIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Razor Wind", "Viento Cortante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWORDS_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Swords Dance", "Danza Espada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cut", "Corte"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gust", "Tornado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WING_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wing Attack", "Ataque Ala"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WHIRLWIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Whirlwind", "Remolino"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fly", "Vuelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bind", "Atadura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Slam", "Atizar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VINE_WHIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Vine Whip", "Látigo Cepa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STOMP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stomp", "Pisotón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Kick", "Doble Patada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEGA_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mega Kick", "Megapatada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JUMP_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Jump Kick", "Patada Salto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROLLING_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rolling Kick", "Patada Giro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAND_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sand Attack", "Ataque Arena"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEADBUTT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Headbutt", "Golpe Cabeza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Horn Attack", "Cornada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FURY_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fury Attack", "Ataque Furia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_DRILL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Horn Drill", "Perforador"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TACKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tackle", "Placaje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BODY_SLAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Body Slam", "Golpe Cuerpo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WRAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wrap", "Constricción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAKE_DOWN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Take Down", "Derribo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THRASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thrash", "Saña"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_EDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double-Edge", "Doble Filo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAIL_WHIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tail Whip", "Látigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_STING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Sting", "Picotazo Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWINEEDLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Twineedle", "Doble Ataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PIN_MISSILE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pin Missile", "Pin Misil"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leer", "Malicioso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BITE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bite", "Mordisco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GROWL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Growl", "Gruñido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROAR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Roar", "Rugido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sing", "Canto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERSONIC] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Supersonic", "Supersónico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SONIC_BOOM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sonic Boom", "Bomba Sónica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DISABLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Disable", "Anulación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acid", "Ácido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EMBER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ember", "Ascuas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAMETHROWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flamethrower", "Lanzallamas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mist", "Neblina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_GUN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Gun", "Pistola Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_PUMP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hydro Pump", "Hidrobomba"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SURF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Surf", "Surf"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Beam", "Rayo Hielo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLIZZARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blizzard", "Ventisca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYBEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psybeam", "Psicorrayo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bubble Beam", "Rayo Burbuja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURORA_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aurora Beam", "Rayo Aurora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyper Beam", "Hiperrayo"),
    ...
    [MOVE_PECK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Peck", "Picotazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRILL_PECK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Drill Peck", "Pico Taladro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUBMISSION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Submission", "Sumisión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOW_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Low Kick", "Patada Baja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COUNTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Counter", "Contraataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEISMIC_TOSS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Seismic Toss", "Sísmico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRENGTH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Strength", "Fuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ABSORB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Absorb", "Absorber"),
        .description = COMPOUND_STRING(
            "An attack that absorbs\n"
            "half the damage inflicted."),
    ...
    [MOVE_MEGA_DRAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mega Drain", "Megaagotar"),
    ...
    [MOVE_LEECH_SEED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leech Seed", "Drenadoras"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GROWTH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Growth", "Desarrollo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAZOR_LEAF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Razor Leaf", "Hoja Afilada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOLAR_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Solar Beam", "Rayo Solar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_POWDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Powder", "Polvo Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STUN_SPORE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stun Spore", "Paralizador"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLEEP_POWDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sleep Powder", "Somnífero"),
        .description = COMPOUND_STRING(
            "Scatters a powder that may\n"
    ...
    [MOVE_PETAL_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Petal Dance", "Danza Pétalo"),
        .description = COMPOUND_STRING(
            "A rampage of 2 to 3 turns\n"
            "that confuses the user."),
        #if B_UPDATED_MOVE_DATA >= GEN_5
    ...
    [MOVE_STRING_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("String Shot", "Disparo Demora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_RAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Rage", "Furia Dragón"),
        .description = COMPOUND_STRING(
            "Launches shock waves that\n"
    ...
    [MOVE_FIRE_SPIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Spin", "Giro Fuego"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_SHOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder Shock", "Impactrueno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDERBOLT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunderbolt", "Rayo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_WAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder Wave", "Onda Trueno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder", "Trueno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_THROW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Throw", "Lanzarrocas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EARTHQUAKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Earthquake", "Terremoto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FISSURE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fissure", "Fisura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dig", "Excavar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TOXIC] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Toxic", "Tóxico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONFUSION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Confusion", "Confusión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psychic", "Psíquico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPNOSIS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hypnosis", "Hipnosis"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEDITATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Meditate", "Meditación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AGILITY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Agility", "Agilidad"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUICK_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Quick Attack", "Ataque Rápido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rage", "Furia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TELEPORT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Teleport", "Teletransporte"),
    ...
    [MOVE_NIGHT_SHADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Night Shade", "Tinieblas"),
        .description = COMPOUND_STRING(
            "Inflicts damage identical\n"
            "to the user's level."),
        .effect = EFFECT_LEVEL_DAMAGE,
    ...
    [MOVE_MIMIC] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mimic", "Mimético"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCREECH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Screech", "Chirrido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_TEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Team", "Doble Equipo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RECOVER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Recover", "Recuperación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HARDEN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Harden", "Fortaleza"),
        .description = COMPOUND_STRING(
            "Stiffens the body's \n"
    ...
    [MOVE_MINIMIZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Minimize", "Reducción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMOKESCREEN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Smokescreen", "Pantalla de Humo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONFUSE_RAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Confuse Ray", "Rayo Confuso"),
        .description = COMPOUND_STRING(
            "A sinister ray that\n"
            "confuses the foe."),
        .effect = EFFECT_CONFUSE,
    ...
    [MOVE_WITHDRAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Withdraw", "Refugio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DEFENSE_CURL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Defense Curl", "Rizo Defensa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BARRIER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Barrier", "Barrera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIGHT_SCREEN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Light Screen", "Pantalla Luz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Haze", "Niebla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REFLECT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Reflect", "Reflejo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOCUS_ENERGY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Focus Energy", "Foco Energía"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BIDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bide", "Venganza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METRONOME] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Metronome", "Metrónomo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRROR_MOVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mirror Move", "Espejo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Self-Destruct", "Autodestrucción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EGG_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Egg Bomb", "Bomba Huevo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lick", "Lengüetazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMOG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Smog", "Polución"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLUDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sludge", "Residuos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BONE_CLUB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bone Club", "Hueso Palo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Blast", "Llamarada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATERFALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Waterfall", "Cascada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CLAMP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Clamp", "Tenaza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWIFT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Swift", "Meteoros"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKULL_BASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Skull Bash", "Cabezazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIKE_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spike Cannon", "Clavo Cañón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONSTRICT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Constrict", "Restricción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AMNESIA] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Amnesia", "Amnesia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KINESIS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Kinesis", "Kinético"),
        .description = COMPOUND_STRING(
            "Distracts the foe.\n"
            "May lower accuracy."),
        .effect = EFFECT_ACCURACY_DOWN,
    ...
    [MOVE_SOFT_BOILED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Soft-Boiled", "Ovocuración"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "user's maximum HP."),
    ...
    [MOVE_HIGH_JUMP_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("High Jump Kick", "Pat. Salto Alta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Glare", "Deslumbrar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DREAM_EATER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dream Eater", "Comesueños"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_GAS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Gas", "Gas Venenoso"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_5
    ...
    [MOVE_BARRAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Barrage", "Bombardeo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEECH_LIFE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leech Life", "Chupavidas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOVELY_KISS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lovely Kiss", "Beso Amoroso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKY_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sky Attack", "Ataque Aéreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRANSFORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Transform", "Transformación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUBBLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bubble", "Burbuja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dizzy Punch", "Puño Mareo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPORE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spore", "Espora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flash", "Destello"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYWAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psywave", "Psicoonda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Splash", "Salpicadura"),
        .description = COMPOUND_STRING(
            "It's just a splash...\n"
    ...
    [MOVE_ACID_ARMOR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acid Armor", "Armadura Ácida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRABHAMMER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Crabhammer", "Martillazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EXPLOSION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Explosion", "Explosión"),
        .description = COMPOUND_STRING(
            "Inflicts severe damage but\n"
            "makes the user faint."),
        .effect = EFFECT_EXPLOSION,
    ...
    [MOVE_FURY_SWIPES] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fury Swipes", "Golpes Furia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BONEMERANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bonemerang", "Huesomerang"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rest", "Descanso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_SLIDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Slide", "Avalancha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyper Fang", "Hipercolmillo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHARPEN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sharpen", "Afilar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONVERSION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Conversion", "Conversión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRI_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tri Attack", "Triataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPER_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Super Fang", "Superdiente"),
        .description = COMPOUND_STRING(
            "Attacks with sharp fangs\n"
    ...
    [MOVE_SLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Slash", "Cuchillada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUBSTITUTE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Substitute", "Sustituto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRUGGLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Struggle", "Forcejeo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKETCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sketch", "Esquema"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Triple Kick", "Triple Patada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THIEF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thief", "Ladrón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIDER_WEB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spider Web", "Telaraña"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIND_READER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mind Reader", "Telépata"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHTMARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Nightmare", "Pesadilla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAME_WHEEL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flame Wheel", "Rueda Fuego"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNORE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snore", "Ronquido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CURSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Curse", "Maldición"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flail", "Azote"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONVERSION_2] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Conversion 2", "Conversión2"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AEROBLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aeroblast", "Aerochorro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COTTON_SPORE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cotton Spore", "Esporagodón"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
    ...
    [MOVE_REVERSAL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Reversal", "Inversión"),
        .description = COMPOUND_STRING(
            "Inflicts more damage when\n"
            "the user's HP is down."),
        .effect = EFFECT_FLAIL,
    ...
    [MOVE_SPITE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spite", "Rencor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWDER_SNOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Powder Snow", "Nieve Polvo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PROTECT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Protect", "Protección"),
    ...
    [MOVE_MACH_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mach Punch", "Ultrapuño"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCARY_FACE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Scary Face", "Cara Susto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FEINT_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Feint Attack", "Finta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWEET_KISS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sweet Kiss", "Beso Dulce"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BELLY_DRUM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Belly Drum", "Tambor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLUDGE_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sludge Bomb", "Bomba Lodo"),
        .description = COMPOUND_STRING(
            "Sludge is hurled to inflict\n"
            "damage. May also poison."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_MUD_SLAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mud-Slap", "Bofetón Lodo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OCTAZOOKA] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Octazooka", "Pulpocañón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIKES] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spikes", "Púas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZAP_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Zap Cannon", "Electrocañón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FORESIGHT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Foresight", "Profecía"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DESTINY_BOND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Destiny Bond", "Mismo Destino"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PERISH_SONG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Perish Song", "Canto Mortal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICY_WIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Icy Wind", "Viento Hielo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DETECT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Detect", "Detección"),
        .description = sProtectDescription,
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_BONE_RUSH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bone Rush", "Ataque Óseo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOCK_ON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lock-On", "Fijar Blanco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OUTRAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Outrage", "Enfado"),
        .description = COMPOUND_STRING(
            "A rampage of 2 to 3 turns\n"
            "that confuses the user."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SANDSTORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sandstorm", "Tormenta Arena"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGA_DRAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Giga Drain", "Gigadrenado"),
        .description = COMPOUND_STRING(
            "An attack that steals half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_ENDURE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Endure", "Aguante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHARM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Charm", "Encanto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROLLOUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rollout", "Rodar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FALSE_SWIPE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("False Swipe", "Falso Tortazo"),
    ...
    [MOVE_SWAGGER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Swagger", "Contoneo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MILK_DRINK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Milk Drink", "Batido"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "user's maximum HP."),
        .effect = EFFECT_SOFTBOILED,
    ...
    [MOVE_SPARK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spark", "Chispa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FURY_CUTTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fury Cutter", "Corte Furia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_WING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Steel Wing", "Ala de Acero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEAN_LOOK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mean Look", "Mal de Ojo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ATTRACT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Attract", "Atracción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLEEP_TALK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sleep Talk", "Sonámbulo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_BELL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heal Bell", "Cascabel Cura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RETURN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Return", "Retribución"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PRESENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Present", "Presente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FRUSTRATION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Frustration", "Frustración"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAFEGUARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Safeguard", "Velo Sagrado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PAIN_SPLIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pain Split", "Divide Dolor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SACRED_FIRE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sacred Fire", "Fuego Sagrado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNITUDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magnitude", "Magnitud"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DYNAMIC_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dynamic Punch", "Puño Dinámico"),
        .description = COMPOUND_STRING(
            "Powerful and sure to cause\n"
    ...
    [MOVE_MEGAHORN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Megahorn", "Megacuerno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_BREATH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Breath", "Dragoaliento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BATON_PASS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Baton Pass", "Relevo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENCORE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Encore", "Otra Vez"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PURSUIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pursuit", "Persecución"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAPID_SPIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rapid Spin", "Giro Rápido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWEET_SCENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sweet Scent", "Dulce Aroma"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
    ...
    [MOVE_IRON_TAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Iron Tail", "Cola Férrea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_CLAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Metal Claw", "Garra Metal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VITAL_THROW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Vital Throw", "Llave Vital"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MORNING_SUN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Morning Sun", "Sol Matinal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SYNTHESIS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Synthesis", "Síntesis"),
        .description = COMPOUND_STRING(
            "Restores HP. The amount\n"
            "varies with the weather."),
    ...
    [MOVE_MOONLIGHT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Moonlight", "Luz Lunar"),
        .description = COMPOUND_STRING(
            "Restores HP. The amount\n"
            "varies with the weather."),
    ...
    [MOVE_HIDDEN_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hidden Power", "Poder Oculto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CROSS_CHOP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cross Chop", "Tajo Cruzado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWISTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Twister", "Ciclón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAIN_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rain Dance", "Danza Lluvia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUNNY_DAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sunny Day", "Día Soleado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Crunch", "Triturar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRROR_COAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mirror Coat", "Manto Espejo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCH_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psych Up", "Autosugestión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EXTREME_SPEED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Extreme Speed", "Veloc. Extrema"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ANCIENT_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ancient Power", "Poder Pasado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Ball", "Bola Sombra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUTURE_SIGHT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Future Sight", "Premonición"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_SMASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Smash", "Golpe Roca"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WHIRLPOOL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Whirlpool", "Torbellino"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEAT_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Beat Up", "Paliza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAKE_OUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fake Out", "Sorpresa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_UPROAR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Uproar", "Alboroto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STOCKPILE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stockpile", "Reserva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIT_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spit Up", "Escupir"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWALLOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Swallow", "Tragar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAT_WAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heat Wave", "Onda Ígnea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hail", "Granizo"),
    ...
    [MOVE_TORMENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Torment", "Tormento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLATTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flatter", "Camelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WILL_O_WISP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Will-O-Wisp", "Fuego Fatuo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEMENTO] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Memento", "Legado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FACADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Facade", "Imagen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOCUS_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Focus Punch", "Puño Certero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMELLING_SALTS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Smelling Salts", "Estímulo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOLLOW_ME] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Follow Me", "Señuelo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NATURE_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Nature Power", "Adaptación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHARGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Charge", "Carga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAUNT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Taunt", "Mofa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HELPING_HAND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Helping Hand", "Refuerzo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trick", "Truco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROLE_PLAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Role Play", "Imitación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WISH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wish", "Deseo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASSIST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Assist", "Ayuda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INGRAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ingrain", "Arraigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERPOWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Superpower", "Fuerza Bruta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_COAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magic Coat", "Capa Mágica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RECYCLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Recycle", "Reciclaje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REVENGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Revenge", "Desquite"),
    ...
    [MOVE_BRICK_BREAK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Brick Break", "Demolición"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_YAWN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Yawn", "Bostezo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KNOCK_OFF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Knock Off", "Desarme"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENDEAVOR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Endeavor", "Esfuerzo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ERUPTION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Eruption", "Estallido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKILL_SWAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Skill Swap", "Intercambio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_IMPRISON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Imprison", "Sellar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_REFRESH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Refresh", "Alivio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRUDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grudge", "Rabia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNATCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snatch", "Robo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SECRET_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Secret Power", "Daño Secreto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dive", "Buceo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ARM_THRUST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Arm Thrust", "Empujón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CAMOUFLAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Camouflage", "Camuflaje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAIL_GLOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tail Glow", "Luminicola"),
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_5
    ...
    [MOVE_LUSTER_PURGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Luster Purge", "Resplandor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIST_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mist Ball", "Bola Neblina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FEATHER_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Feather Dance", "Danza Pluma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEETER_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Teeter Dance", "Danza Caos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZE_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blaze Kick", "Patada Ígnea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MUD_SPORT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mud Sport", "Chapoteo Lodo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Ball", "Bola Hielo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NEEDLE_ARM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Needle Arm", "Brazo Pincho"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLACK_OFF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Slack Off", "Relajo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_VOICE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyper Voice", "Vozarrón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Fang", "Colmillo Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRUSH_CLAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Crush Claw", "Garra Brutal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAST_BURN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blast Burn", "Anillo Ígneo"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_HYDRO_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hydro Cannon", "Hidrocañón"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_METEOR_MASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Meteor Mash", "Puño Meteoro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASTONISH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Astonish", "Impresionar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WEATHER_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Weather Ball", "Meteorobola"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AROMATHERAPY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aromatherapy", "Aromaterapia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAKE_TEARS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fake Tears", "Llanto Falso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AIR_CUTTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Air Cutter", "Aire Afilado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OVERHEAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Overheat", "Sofoco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ODOR_SLEUTH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Odor Sleuth", "Rastreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_TOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Tomb", "Tumba Rocas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SILVER_WIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Silver Wind", "Viento Plata"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_SOUND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Metal Sound", "Eco Metálico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASS_WHISTLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grass Whistle", "Silbato"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TICKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tickle", "Cosquillas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COSMIC_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cosmic Power", "Masa Cósmica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_SPOUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Spout", "Salpicar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SIGNAL_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Signal Beam", "Rayo Señal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Punch", "Puño Sombra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EXTRASENSORY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Extrasensory", "Paranormal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKY_UPPERCUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sky Uppercut", "Gancho Alto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAND_TOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sand Tomb", "Bucle Arena"),
        .description = COMPOUND_STRING(
            "Traps and hurts the foe in\n"
    ...
    [MOVE_SHEER_COLD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sheer Cold", "Frío Polar"),
        .description = COMPOUND_STRING(
            "A chilling attack that\n"
    ...
    [MOVE_MUDDY_WATER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Muddy Water", "Agua Lodosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLET_SEED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bullet Seed", "Semilladora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AERIAL_ACE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aerial Ace", "Golpe Aéreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICICLE_SPEAR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Icicle Spear", "Carámbano"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_IRON_DEFENSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Iron Defense", "Defensa Férrea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Block", "Bloqueo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HOWL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Howl", "Aullido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_CLAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Claw", "Garra Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FRENZY_PLANT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Frenzy Plant", "Planta Feroz"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BULK_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bulk Up", "Corpulencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOUNCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bounce", "Bote"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MUD_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mud Shot", "Disparo Lodo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_TAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Tail", "Cola Veneno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COVET] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Covet", "Antojo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VOLT_TACKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Volt Tackle", "Placaje Eléc"),
        #if B_UPDATED_MOVE_DATA >= GEN_4
        .description = COMPOUND_STRING(
            "A life-risking tackle that\n"
    ...
    [MOVE_MAGICAL_LEAF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magical Leaf", "Hoja Mágica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_SPORT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Sport", "Hidrochorro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CALM_MIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Calm Mind", "Paz Mental"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEAF_BLADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leaf Blade", "Hoja Aguda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Dance", "Danza Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Blast", "Pedrada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHOCK_WAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shock Wave", "Onda Voltio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Pulse", "Hidropulso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOOM_DESIRE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Doom Desire", "Deseo Oculto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHO_BOOST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psycho Boost", "Psicoataque"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ROOST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Roost", "Respiro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRAVITY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gravity", "Gravedad"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRACLE_EYE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Miracle Eye", "Gran Ojo"),
        .description = COMPOUND_STRING(
            "Negate evasiveness and\n"
    ...
    [MOVE_WAKE_UP_SLAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wake-Up Slap", "Espabila"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAMMER_ARM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hammer Arm", "Machada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GYRO_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gyro Ball", "Giro Bola"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEALING_WISH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Healing Wish", "Deseo Cura"),
    ...
    [MOVE_BRINE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Brine", "Salmuera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NATURAL_GIFT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Natural Gift", "Don Natural"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FEINT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Feint", "Amago"),
    ...
    [MOVE_PLUCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pluck", "Picoteo"),
    ...
    [MOVE_TAILWIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tailwind", "Viento Afín"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACUPRESSURE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acupressure", "Acupresión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METAL_BURST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Metal Burst", "Represión Metal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_U_TURN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("U-turn", "Ida y Vuelta"),
    ...
    [MOVE_CLOSE_COMBAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Close Combat", "A Bocajarro"),
    ...
    [MOVE_PAYBACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Payback", "Vendetta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASSURANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Assurance", "Buena Baza"),
        .description = COMPOUND_STRING(
            "An attack that gains power\n"
    ...
    [MOVE_EMBARGO] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Embargo", "Embargo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fling", "Lanzamiento"),
        .description = COMPOUND_STRING(
            "The effectiveness varies\n"
            "with the held item."),
        .effect = EFFECT_FLING,
    ...
    [MOVE_PSYCHO_SHIFT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psycho Shift", "Psicocambio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRUMP_CARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trump Card", "As Oculto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_BLOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heal Block", "Anticura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WRING_OUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wring Out", "Estrujón"),
    ...
    [MOVE_POWER_TRICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Trick", "Truco Fuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GASTRO_ACID] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gastro Acid", "Bilis"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUCKY_CHANT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lucky Chant", "Conjuro"),
        .description = COMPOUND_STRING(
            "Prevents the foe from\n"
    ...
    [MOVE_ME_FIRST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Me First", "Yo Primero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COPYCAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Copycat", "Copión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_SWAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Swap", "Cambiafuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUARD_SWAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Guard Swap", "Cambiadefensa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PUNISHMENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Punishment", "Castigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LAST_RESORT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Last Resort", "Última Baza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WORRY_SEED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Worry Seed", "Abatidoras"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUCKER_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sucker Punch", "Golpe Bajo"),
    ...
    [MOVE_TOXIC_SPIKES] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Toxic Spikes", "Púas Tóxicas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEART_SWAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heart Swap", "Cambiaalmas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_RING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aqua Ring", "Acua Aro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNET_RISE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magnet Rise", "Levitón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLARE_BLITZ] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flare Blitz", "Envite Ígneo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FORCE_PALM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Force Palm", "Palmeo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURA_SPHERE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aura Sphere", "Esfera Aural"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_POLISH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Polish", "Pulimento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POISON_JAB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poison Jab", "Puya Nociva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARK_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dark Pulse", "Pulso Umbrío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHT_SLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Night Slash", "Tajo Umbrío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_TAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aqua Tail", "Acua Cola"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEED_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Seed Bomb", "Bomba Germen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AIR_SLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Air Slash", "Tajo Aéreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_X_SCISSOR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("X-Scissor", "Tijera X"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUG_BUZZ] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bug Buzz", "Zumbido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Pulse", "Pulso Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_RUSH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Rush", "Carga Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_GEM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Gem", "Joya de Luz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Drain Punch", "Puño Drenaje"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 75 : 60,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_VACUUM_WAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Vacuum Wave", "Onda Vacío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FOCUS_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Focus Blast", "Onda Certera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENERGY_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Energy Ball", "Energibola"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRAVE_BIRD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Brave Bird", "Pájaro Osado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EARTH_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Earth Power", "Tierra Viva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SWITCHEROO] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Switcheroo", "Trapicheo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGA_IMPACT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Giga Impact", "Gigaimpacto"),
        .description = sHyperBeamDescription,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_NORMAL,
    ...
    [MOVE_NASTY_PLOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Nasty Plot", "Maquinación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLET_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bullet Punch", "Puño Bala"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AVALANCHE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Avalanche", "Alud"),
        .description = sRevengeDescription,
        .effect = EFFECT_REVENGE,
        .power = 60,
        .type = TYPE_ICE,
    ...
    [MOVE_ICE_SHARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Shard", "Esquirla Helada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_CLAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Claw", "Garra Umbría"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder Fang", "Colmillo Rayo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Fang", "Colmillo Hielo"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
        #if B_USE_FROSTBITE == TRUE
            "leave the foe with frostbite."),
    ...
    [MOVE_FIRE_FANG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Fang", "Colmillo Ígneo"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
    ...
    [MOVE_SHADOW_SNEAK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Sneak", "Sombra Vil"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MUD_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mud Bomb", "Bomba Fango"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHO_CUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psycho Cut", "Psicocorte"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZEN_HEADBUTT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Zen Headbutt", "Cabezazo Zen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIRROR_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mirror Shot", "Disparo Espejo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLASH_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flash Cannon", "Foco Resplandor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_CLIMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Climb", "Treparrocas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DEFOG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Defog", "Despejar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRICK_ROOM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trick Room", "Espacio Raro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRACO_METEOR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Draco Meteor", "Cometa Draco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DISCHARGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Discharge", "Chispazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LAVA_PLUME] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lava Plume", "Humareda"),
    ...
    [MOVE_LEAF_STORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leaf Storm", "Lluevahojas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_WHIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Whip", "Latigazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROCK_WRECKER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rock Wrecker", "Romperrocas"),
        .description = sHyperBeamDescription,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_ROCK,
    ...
    [MOVE_CROSS_POISON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cross Poison", "Veneno X"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUNK_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gunk Shot", "Lanzamugre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_IRON_HEAD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Iron Head", "Cabeza de Hierro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNET_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magnet Bomb", "Bomba Imán"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STONE_EDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stone Edge", "Roca Afilada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CAPTIVATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Captivate", "Seducción"),
        .description = COMPOUND_STRING(
            "Makes the opposite gender\n"
    ...
    [MOVE_STEALTH_ROCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stealth Rock", "Trampa Rocas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASS_KNOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grass Knot", "Hierba Lazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHATTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Chatter", "Cháchara"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JUDGMENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Judgment", "Sentencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BUG_BITE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bug Bite", "Picadura"),
        .description = sPluckDescription,
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
    ...
    [MOVE_CHARGE_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Charge Beam", "Rayo Carga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WOOD_HAMMER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wood Hammer", "Mazazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_JET] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aqua Jet", "Acua Jet"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ATTACK_ORDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Attack Order", "Al Ataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DEFEND_ORDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Defend Order", "A Defender"),
        .description = COMPOUND_STRING(
            "Raises Defense and Sp. Def\n"
    ...
    [MOVE_HEAL_ORDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heal Order", "Auxilio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAD_SMASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Head Smash", "Testarazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOUBLE_HIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Hit", "Doble Golpe"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROAR_OF_TIME] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Roar of Time", "Distorsión"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SPACIAL_REND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spacial Rend", "Corte Vacío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUNAR_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lunar Dance", "Danza Lunar"),
        .description = sHealingWishDescription,
        .effect = EFFECT_HEALING_WISH,
        .power = 0,
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_CRUSH_GRIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Crush Grip", "Agarrón"),
        .description = sWringOutDescription,
        .effect = EFFECT_POWER_BASED_ON_TARGET_HP,
        .power = 120,
        .type = TYPE_NORMAL,
    ...
    [MOVE_MAGMA_STORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magma Storm", "Lluvia Ígnea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARK_VOID] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dark Void", "Brecha Negra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEED_FLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Seed Flare", "Fulgor Semilla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OMINOUS_WIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ominous Wind", "Viento Aciago"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_FORCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Force", "Golpe Umbrío"),
    ...
    [MOVE_HONE_CLAWS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hone Claws", "Afilagarras"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WIDE_GUARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wide Guard", "Vasta Guardia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GUARD_SPLIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Guard Split", "Isoguardia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_SPLIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Split", "Isofuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WONDER_ROOM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wonder Room", "Zona Extraña"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYSHOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psyshock", "Psicocarga"),
    ...
    [MOVE_VENOSHOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Venoshock", "Carga Tóxica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AUTOTOMIZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Autotomize", "Aligerar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGE_POWDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rage Powder", "Polvo Ira"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TELEKINESIS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Telekinesis", "Telequinesis"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_ROOM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magic Room", "Zona Mágica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMACK_DOWN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Smack Down", "Antiaéreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STORM_THROW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Storm Throw", "Llave Corsé"),
    ...
    [MOVE_FLAME_BURST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flame Burst", "Pirotecnia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SLUDGE_WAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sludge Wave", "Onda Tóxica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUIVER_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Quiver Dance", "Danza Aleteo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAVY_SLAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heavy Slam", "Cuerpo Pesado"),
    ...
    [MOVE_SYNCHRONOISE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Synchronoise", "Sincrorruido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Electro Ball", "Bola Voltio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOAK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Soak", "Empapar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLAME_CHARGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flame Charge", "Nitrocarga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Coil", "Enrosque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LOW_SWEEP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Low Sweep", "Puntapié"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID_SPRAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acid Spray", "Bomba Ácida"),
        .description = COMPOUND_STRING(
            "Sprays a hide-melting acid.\n"
            "Sharply reduces Sp. Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FOUL_PLAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Foul Play", "Juego Sucio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SIMPLE_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Simple Beam", "Onda Simple"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ENTRAINMENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Entrainment", "Danza Amiga"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AFTER_YOU] =
    {
        .name = COMPOUND_LANGUAGE_STRING("After You", "Cede Paso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROUND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Round", "Canon"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ECHOED_VOICE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Echoed Voice", "Eco Voz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHIP_AWAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Chip Away", "Guardia Baja"),
    ...
    [MOVE_CLEAR_SMOG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Clear Smog", "Niebla Clara"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STORED_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stored Power", "Poder Reserva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUICK_GUARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Quick Guard", "Anticipo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ALLY_SWITCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ally Switch", "Cambio de Banda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCALD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Scald", "Escaldar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_SMASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shell Smash", "Rompecoraza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAL_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heal Pulse", "Pulso Cura"),
        .description = COMPOUND_STRING(
            "Recovers up to half the\n"
            "target's maximum HP."),
    ...
    [MOVE_HEX] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hex", "Infortunio"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
    ...
    [MOVE_SKY_DROP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sky Drop", "Caída Libre"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHIFT_GEAR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shift Gear", "Cambio de Marcha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CIRCLE_THROW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Circle Throw", "Llave Giro"),
    ...
    [MOVE_INCINERATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Incinerate", "Calcinación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_QUASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Quash", "Último Lugar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACROBATICS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acrobatics", "Acróbata"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "user has no item."),
    ...
    [MOVE_REFLECT_TYPE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Reflect Type", "Clonatipo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RETALIATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Retaliate", "Represalia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FINAL_GAMBIT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Final Gambit", "Sacrificio"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BESTOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bestow", "Ofrenda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INFERNO] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Inferno", "Infierno"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WATER_PLEDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Pledge", "Voto Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_PLEDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Pledge", "Voto Fuego"),
        .description = COMPOUND_STRING(
            "Attacks with a column of\n"
    ...
    [MOVE_GRASS_PLEDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grass Pledge", "Voto Planta"),
        .description = COMPOUND_STRING(
            "Attacks with a column of\n"
    ...
    [MOVE_VOLT_SWITCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Volt Switch", "Voltiocambio"),
        .description = sUTurnDescription,
        .effect = EFFECT_HIT_ESCAPE,
        .power = 70,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_STRUGGLE_BUG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Struggle Bug", "Estoicismo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BULLDOZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bulldoze", "Terratemblor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FROST_BREATH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Frost Breath", "Vaho Gélido"),
        .description = sStormThrowDescription,
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 60 : 40,
        .type = TYPE_ICE,
    ...
    [MOVE_DRAGON_TAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Tail", "Cola Dragón"),
        .description = sCircleThrowDescription,
        .effect = EFFECT_HIT_SWITCH_TARGET,
        .power = 60,
        .type = TYPE_DRAGON,
    ...
    [MOVE_WORK_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Work Up", "Avivar"),
        .description = COMPOUND_STRING(
            "The user is roused.\n"
    ...
    [MOVE_ELECTROWEB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Electroweb", "Electrotela"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WILD_CHARGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wild Charge", "Voltio Cruel"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRILL_RUN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Drill Run", "Taladradora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DUAL_CHOP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dual Chop", "Golpe Bis"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEART_STAMP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heart Stamp", "Arrumaco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HORN_LEECH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Horn Leech", "Asta Drenaje"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = 75,
        .type = TYPE_GRASS,
    ...
    [MOVE_SACRED_SWORD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sacred Sword", "Espada Santa"),
        .description = sChipAwayDescription,
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_RAZOR_SHELL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Razor Shell", "Concha Filo"),
        .description = COMPOUND_STRING(
            "Tears at the foe with sharp\n"
    ...
    [MOVE_HEAT_CRASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Heat Crash", "Golpe Calor"),
        .description = sHeavySlamDescription,
        .effect = EFFECT_HEAT_CRASH,
        .power = 1,
        .type = TYPE_FIRE,
    ...
    [MOVE_LEAF_TORNADO] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leaf Tornado", "Ciclón de Hojas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEAMROLLER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Steamroller", "Rodillo de Púas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COTTON_GUARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Cotton Guard", "Rizo Algodón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NIGHT_DAZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Night Daze", "Pulso Noche"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYSTRIKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psystrike", "Onda Mental"),
        .description = sPsyshockDescription,
        .effect = EFFECT_PSYSHOCK,
        .power = 100,
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_TAIL_SLAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tail Slap", "Plumerazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HURRICANE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hurricane", "Vendaval"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEAD_CHARGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Head Charge", "Ariete"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GEAR_GRIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gear Grind", "Rueda Doble"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SEARING_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Searing Shot", "Bomba Ígnea"),
        .description = sLavaPlumeDescription,
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIRE,
    ...
    [MOVE_TECHNO_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Techno Blast", "Tecno Shock"),
        .description = COMPOUND_STRING(
            "The type varies with the\n"
            "kind of Drive held."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
    ...
    [MOVE_RELIC_SONG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Relic Song", "Canto Arcaico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SECRET_SWORD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Secret Sword", "Sable Místico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLACIATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Glaciate", "Mundo Gélido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOLT_STRIKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bolt Strike", "Ataque Fulgor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLUE_FLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blue Flare", "Llama Azul"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIERY_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fiery Dance", "Danza Llama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FREEZE_SHOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Freeze Shock", "Rayo Gélido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_BURN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Burn", "Llama Gélida"),
        .description = COMPOUND_STRING(
            "A powerful 2-turn move that\n"
            "may inflict a burn."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
    ...
    [MOVE_SNARL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snarl", "Alarido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICICLE_CRASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Icicle Crash", "Chuzos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_V_CREATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("V-create", "V de Fuego"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUSION_FLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fusion Flare", "Llama Fusión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FUSION_BOLT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fusion Bolt", "Rayo Fusión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLYING_PRESS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flying Press", "Plancha Voladora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAT_BLOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mat Block", "Escudo Tatami"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BELCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Belch", "Eructo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ROTOTILLER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rototiller", "Fertilizante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STICKY_WEB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sticky Web", "Red Viscosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FELL_STINGER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fell Stinger", "Red Viscosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PHANTOM_FORCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Phantom Force", "Golpe Fantasma"),
        .description = sShadowForceDescription,
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 90,
        .type = TYPE_GHOST,
    ...
    [MOVE_TRICK_OR_TREAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trick-or-Treat", "Halloween"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NOBLE_ROAR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Noble Roar", "Rugido de Guerra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ION_DELUGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ion Deluge", "Cortina Plasma"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Parabolic Charge", "Carga Parábola"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FORESTS_CURSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Forest's Curse", "Condena Silvana"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PETAL_BLIZZARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Petal Blizzard", "Tormenta Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FREEZE_DRY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Freeze-Dry", "Liofilización"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Disarming Voice", "Voz Cautivadora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PARTING_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Parting Shot", "Última Palabra"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TOPSY_TURVY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Topsy-Turvy", "Reversión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAINING_KISS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Draining Kiss", "Beso Drenaje"),
    ...
    [MOVE_CRAFTY_SHIELD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Crafty Shield", "Truco Defensa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLOWER_SHIELD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flower Shield", "Defensa Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASSY_TERRAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grassy Terrain", "Campo de Hierba"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MISTY_TERRAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Misty Terrain", "Campo de Niebla"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRIFY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Electrify", "Electrificación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLAY_ROUGH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Play Rough", "Carantoña"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAIRY_WIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fairy Wind", "Viento Feérico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONBLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Moonblast", "Fuerza Lunar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOOMBURST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Boomburst", "Estruendo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FAIRY_LOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fairy Lock", "Cerrojo Feérico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KINGS_SHIELD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("King's Shield", "Escudo Real"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLAY_NICE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Play Nice", "Camaradería"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONFIDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Confide", "Confidencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIAMOND_STORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Diamond Storm", "Torm. Diamantes"),
        .description = COMPOUND_STRING(
            "Whips up a storm of\n"
    ...
    [MOVE_STEAM_ERUPTION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Steam Eruption", "Chorro de Vapor"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyperspace Hole", "Paso Dimensional"),
    ...
    [MOVE_WATER_SHURIKEN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Water Shuriken", "Shuriken de Agua"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MYSTICAL_FIRE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mystical Fire", "Llama Embrujada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIKY_SHIELD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spiky Shield", "Barrera Espinosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AROMATIC_MIST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aromatic Mist", "Niebla Aromática"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EERIE_IMPULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Eerie Impulse", "Onda Anómala"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VENOM_DRENCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Venom Drench", "Trampa Venenosa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Powder", "Polvo Explosivo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GEOMANCY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Geomancy", "Geocontrol"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGNETIC_FLUX] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magnetic Flux", "Aura Magnética"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HAPPY_HOUR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Happy Hour", "Paga Extra"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Electric Terrain", "Campo Eléctrico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DAZZLING_GLEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dazzling Gleam", "Brillo Mágico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CELEBRATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Celebrate", "Celebración"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HOLD_HANDS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hold Hands", "Manos Juntas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BABY_DOLL_EYES] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Baby-Doll Eyes", "Ojitos Tiernos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NUZZLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Nuzzle", "Moflete Estático"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HOLD_BACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hold Back", "Clemencia"),
        .description = sFalseSwipeDescription,
        .effect = EFFECT_FALSE_SWIPE,
        .power = 40,
        .type = TYPE_NORMAL,
    ...
    [MOVE_INFESTATION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Infestation", "Acoso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_UP_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power-Up Punch", "Puño Incremento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OBLIVION_WING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Oblivion Wing", "Ala Mortífera"),
        .description = sDrainingKissDescription,
        .effect = EFFECT_ABSORB,
        .power = 80,
        .type = TYPE_FLYING,
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Thousand Arrows", "Mil Flechas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THOUSAND_WAVES] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thousand Waves", "Mil Temblores"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LANDS_WRATH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Land's Wrath", "Fuerza Telúrica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIGHT_OF_RUIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Light Of Ruin", "Luz Aniquiladora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ORIGIN_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Origin Pulse", "Pulso Primigenio"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Precipice Blades", "Filo del Abismo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_ASCENT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Ascent", "Ascenso Draco"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FLYING,
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyperspace Fury", "Cerco Dimensión"),
        .description = sHyperspaceHoleDescription,
    ...
    [MOVE_SHORE_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shore Up", "Recogearena"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("First Impression", "Escaramuza"),
        .description = COMPOUND_STRING(
            "Hits hard and first.\n"
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Baneful Bunker", "Búnker"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRIT_SHACKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spirit Shackle", "Puntada Sombría"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARKEST_LARIAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Darkest Lariat", "Lariat Oscuro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sparkling Aria", "Aria Burbuja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_HAMMER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Hammer", "Martillo Hielo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLORAL_HEALING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Floral Healing", "Cura Floral"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("High Horsepower", "Fuerza Equina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRENGTH_SAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Strength Sap", "Absorbefuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOLAR_BLADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Solar Blade", "Cuchilla Solar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LEAFAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Leafage", "Follaje"),
        .description = COMPOUND_STRING(
            "Attacks with a flurry of\n"
            "small leaves."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SPOTLIGHT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spotlight", "Foco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TOXIC_THREAD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Toxic Thread", "Hilo Venenoso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LASER_FOCUS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Laser Focus", "Aguzar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GEAR_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gear Up", "Piñón Auxiliar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THROAT_CHOP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Throat Chop", "Golpe Mordaza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POLLEN_PUFF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pollen Puff", "Bola de Polen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ANCHOR_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Anchor Shot", "Anclaje"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Psychic Terrain", "Campo Psíquico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUNGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lunge", "Plancha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_LASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fire Lash", "Látigo Ígneo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_TRIP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Trip", "Chulería"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BURN_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Burn Up", "Llama Final"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPEED_SWAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Speed Swap", "Cambiavelocidad"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SMART_STRIKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Smart Strike", "Cuerno Certero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PURIFY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Purify", "Purificación"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Revelation Dance", "Danza Despertar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORE_ENFORCER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Core Enforcer", "Núcleo Castigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TROP_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trop Kick", "Patada Tropica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_INSTRUCT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Instruct", "Mandato"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEAK_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Beak Blast", "Pico Cañón"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Clanging Scales", "Fragor Escamas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_HAMMER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Hammer", "Martillo Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRUTAL_SWING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Brutal Swing", "Giro Vil"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURORA_VEIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aurora Veil", "Velo Aurora"),
        #if B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_SNOW
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_TRAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shell Trap", "Coraza Trampa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLEUR_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fleur Cannon", "Cañón Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC_FANGS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psychic Fangs", "Psicocolmillo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Stomping Tantrum", "Pataleta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHADOW_BONE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shadow Bone", "Hueso Sombrío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACCELEROCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Accelerock", "Roca Veloz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIQUIDATION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Liquidation", "Hidroariete"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Prismatic Laser", "Láser Prisma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPECTRAL_THIEF] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spectral Thief", "Robasombra"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Sunsteel Strike", "Meteoimpacto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOONGEIST_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Moongeist Beam", "Rayo Umbrío"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEARFUL_LOOK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tearful Look", "Ojos Llorosos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZING_ZAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Zing Zap", "Electropunzada"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Nature's Madness", "Furia Natural"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MULTI_ATTACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Multi-Attack", "Multiataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MIND_BLOWN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mind Blown", "Cabeza Sorpresa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLASMA_FISTS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Plasma Fists", "Puños Plasma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PHOTON_GEYSER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Photon Geyser", "Géiser Fotónico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ZIPPY_ZAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Zippy Zap", "Pikaturbo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPLISHY_SPLASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Splishy Splash", "Salpikasurf"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLOATY_FALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Floaty Fall", "Pikapicado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PIKA_PAPOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pika Papow", "Pikatormenta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bouncy Bubble", "Vapodrenaje"),
        .description = COMPOUND_STRING(
            "An attack that absorbs\n"
        #if B_UPDATED_MOVE_DATA >= GEN_8
    ...
    [MOVE_BUZZY_BUZZ] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Buzzy Buzz", "Joltioparálisis"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SIZZLY_SLIDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sizzly Slide", "Flarembestida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLITZY_GLOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Glitzy Glow", "Espeaura"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BADDY_BAD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Baddy Bad", "Umbreozona"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SAPPY_SEED] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sappy Seed", "Leafitobombas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FREEZY_FROST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Freezy Frost", "Glaceoprisma"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPARKLY_SWIRL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sparkly Swirl", "Sylveotornado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VEEVEE_VOLLEY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Veevee Volley", "Eevimpacto"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Iron Bash", "Ferropuño Doble"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DYNAMAX_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dynamax Cannon", "Cañón Dinamax"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNIPE_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snipe Shot", "Disparo Certero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JAW_LOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Jaw Lock", "Presa Maxilar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STUFF_CHEEKS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stuff Cheeks", "Atiborramiento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_NO_RETREAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("No Retreat", "Bastión Final"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAR_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tar Shot", "Alquitranazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAGIC_POWDER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magic Powder", "Polvo Mágico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_DARTS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Darts", "Dracoflechas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEATIME] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Teatime", "Hora del Té"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OCTOLOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Octolock", "Octopresa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOLT_BEAK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bolt Beak", "Electropico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FISHIOUS_REND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fishious Rend", "Branquibocado"),
        .description = COMPOUND_STRING(
            "Double power if the user\n"
            "moves before the target."),
        .effect = EFFECT_BOLT_BEAK,
    ...
    [MOVE_COURT_CHANGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Court Change", "Cambio de Cancha"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Clangorous Soul", "Estruendoescama"), // Estruendo Escama
        .description = COMPOUND_STRING(
    ...
    [MOVE_BODY_PRESS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Body Press", "Plancha Corporal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DECORATE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Decorate", "Decoración"),
        .description = COMPOUND_STRING(
            "The user sharply raises\n"
    ...
    [MOVE_DRUM_BEATING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Drum Beating", "Batería Asalto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNAP_TRAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snap Trap", "Cepo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PYRO_BALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pyro Ball", "Balón Ígneo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEHEMOTH_BLADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Behemoth Blade", "Tajo Supremo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEHEMOTH_BASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Behemoth Bash", "Embate Supremo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AURA_WHEEL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aura Wheel", "Rueda Aural"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BREAKING_SWIPE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Breaking Swipe", "Vasto Impacto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRANCH_POKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Branch Poke", "Punzada Rama"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OVERDRIVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Overdrive", "Amplificador"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_APPLE_ACID] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Apple Acid", "Ácido Málico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRAV_APPLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grav Apple", "Fuerza G"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRIT_BREAK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spirit Break", "Choque Anímico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRANGE_STEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Strange Steam", "Cautivapor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIFE_DEW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Life Dew", "Gota Vital"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_OBSTRUCT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Obstruct", "Obstrucción"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("False Surrender", "Irreverencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METEOR_ASSAULT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Meteor Assault", "Asalto Estelar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ETERNABEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Eternabeam", "Rayo Infinito"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Steel Beam", "Metaláser"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Expanding Force", "Vasta Fuerza"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STEEL_ROLLER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Steel Roller", "Allanador Férreo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCALE_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Scale Shot", "Ráfaga Escamas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_METEOR_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Meteor Beam", "Rayo Meteórico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_SIDE_ARM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shell Side Arm", "Moluscañón"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Misty Explosion", "Bruma Explosiva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GRASSY_GLIDE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Grassy Glide", "Fitoimpulso"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RISING_VOLTAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rising Voltage", "Alto Voltaje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERRAIN_PULSE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Terrain Pulse", "Pulso de Campo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKITTER_SMACK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Skitter Smack", "Golpe Rastrero"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Burning Jealousy", "Envidia Ardiente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LASH_OUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lash Out", "Desahogo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POLTERGEIST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Poltergeist", "Poltergeist"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORROSIVE_GAS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Corrosive Gas", "Gas Corrosivo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COACHING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Coaching", "Motivación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLIP_TURN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flip Turn", "Viraje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_AXEL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Triple Axel", "Triple Axel"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DUAL_WINGBEAT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dual Wingbeat", "Ala Bis"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Scorching Sands", "Arenas Ardientes"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JUNGLE_HEALING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Jungle Healing", "Cura Selvática"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WICKED_BLOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wicked Blow", "Golpe Oscuro"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Surging Strikes", "Azote Torrencial"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDER_CAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunder Cage", "Electrojaula"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_ENERGY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Energy", "Dracoenergía"),
        .description = COMPOUND_STRING(
            "The higher the user's HP\n"
            "the more damage caused."),
        .effect = EFFECT_POWER_BASED_ON_USER_HP,
    ...
    [MOVE_FREEZING_GLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Freezing Glare", "Mirada Heladora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIERY_WRATH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fiery Wrath", "Furia Candente"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunderous Kick", "Patada Relámpago"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Glacial Lance", "Lanza Glacial"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASTRAL_BARRAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Astral Barrage", "Orbes Espectro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EERIE_SPELL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Eerie Spell", "Conjuro Funesto"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DIRE_CLAW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dire Claw", "Garra Nociva"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYSHIELD_BASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psyshield Bash", "Asalto Barrera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_SHIFT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Power Shift", "Cambiapoder"),
        .description = COMPOUND_STRING(
            "The user swaps its Attack\n"
            "and Defense stats."),
        .effect = EFFECT_POWER_TRICK,
    ...
    [MOVE_STONE_AXE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Stone Axe", "Hachazo Pétreo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Springtide Storm", "Ciclón Primavera"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MYSTICAL_POWER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mystical Power", "Poder Místico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGING_FURY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Raging Fury", "Erupción de Ira"),
        .description = COMPOUND_STRING(
            "A rampage of 2 to 3 turns\n"
            "that confuses the user."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_WAVE_CRASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wave Crash", "Envite Acuático"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHLOROBLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Chloroblast", "Clorofiláser"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MOUNTAIN_GALE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mountain Gale", "Viento Carámbano"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VICTORY_DANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Victory Dance", "Danza Triunfal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEADLONG_RUSH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Headlong Rush", "Arremetida"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BARB_BARRAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Barb Barrage", "Mil Púas Tóxicas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ESPER_WING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Esper Wing", "Ala Aural"),
        .description = COMPOUND_STRING(
            "High critical hit ratio.\n"
    ...
    [MOVE_BITTER_MALICE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bitter Malice", "Rencor Reprimido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shelter", "Retracción"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Triple Arrows", "Triple Flecha"),
        .description = COMPOUND_STRING(
            "High critical hit ratio.\n"
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Infernal Parade", "Marcha Espectral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CEASELESS_EDGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ceaseless Edge", "Tajo Metralla"),
        .description = COMPOUND_STRING(
            "High critical hit ratio. Sets\n"
            "Splinters that hurt the foe."),
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Bleakwind Storm", "Vendaval Gélido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WILDBOLT_STORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wildbolt Storm", "Electormenta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SANDSEAR_STORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Sandsear Storm", "Simún de Arena"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUNAR_BLESSING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lunar Blessing", "Plegaria Lunar"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TAKE_HEART] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Take Heart", "Bálsamo Osado"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERA_BLAST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tera Blast", "Teraexplosión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SILK_TRAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Silk Trap", "Telatrampa"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AXE_KICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Axe Kick", "Patada Hacha"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LAST_RESPECTS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Last Respects", "Homenajepóstumo"), // Homenaje Póstumo
        .description = COMPOUND_STRING(
    ...
    [MOVE_LUMINA_CRASH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Lumina Crash", "Fotocolisión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ORDER_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Order Up", "Oído Cocina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_JET_PUNCH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Jet Punch", "Puño Jet"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPICY_EXTRACT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spicy Extract", "Extracto Picante"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIN_OUT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Spin Out", "Quemarrueda"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Population Bomb", "Proliferación"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_SPINNER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ice Spinner", "Pirueta Helada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Glaive Rush", "Asalto Espadón"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Revival Blessing", "Plegaria Vital"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SALT_CURE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Salt Cure", "Salazón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_DIVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Triple Dive", "Triple Inmersión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MORTAL_SPIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mortal Spin", "Giro Mortífero"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DOODLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Doodle", "Decalcomanía"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FILLET_AWAY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fillet Away", "Deslome"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KOWTOW_CLEAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Kowtow Cleave", "Genufendiente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLOWER_TRICK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Flower Trick", "Truco Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TORCH_SONG] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Torch Song", "Canto Ardiente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_STEP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aqua Step", "Danza Acuática"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGING_BULL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Raging Bull", "Furia Taurina"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Make It Rain", "Fiebre Dorada"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RUINATION] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ruination", "Calamidad"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Collision Course", "Nitrochoque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_DRIFT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Electro Drift", "Electroderrape"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHED_TAIL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Shed Tail", "Autotomía"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Chilly Reception", "Fría Acogida"),
    ...
    [MOVE_TIDY_UP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tidy Up", "Limpieza General"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNOWSCAPE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Snowscape", "Paisaje Nevado"),
        #if B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_HAIL
            .description = COMPOUND_STRING(
                "Summons a hailstorm that\n"
                "strikes every turn."),
    ...
    [MOVE_POUNCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Pounce", "Brinco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRAILBLAZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Trailblaze", "Abrecaminos"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHILLING_WATER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Chilling Water", "Agua Fría"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYPER_DRILL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hyper Drill", "Hipertaladro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWIN_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Twin Beam", "Láser Doble"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAGE_FIST] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Rage Fist", "Puño Furia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ARMOR_CANNON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Armor Cannon", "Cañón Armadura"),
        .description = COMPOUND_STRING(
            "A strong attack but lowers\n"
            "the defensive stats."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BITTER_BLADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bitter Blade", "Espada Lamento"),
        .description = COMPOUND_STRING(
            "An attack that absorbs\n"
            "half the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_DOUBLE_SHOCK] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Double Shock", "Electropalmas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGATON_HAMMER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gigaton Hammer", "Martillo Colosal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_COMEUPPANCE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Comeuppance", "Resarcimiento"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_CUTTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Aqua Cutter", "Tajo Acuático"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blazing Torque", "Pirochoque"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Wicked Torque", "Ominochoque"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Noxious Torque", "Ponzochoque"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
    ...
    [MOVE_COMBAT_TORQUE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Combat Torque", "Pugnachoque"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Magical Torque", "Feerichoque"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FAIRY,
    ...
    [MOVE_PSYBLADE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psyblade", "Psicohojas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_STEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hydro Steam", "Hidrovapor"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
    ...
    [MOVE_BLOOD_MOON] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Blood Moon", "Luna Roja"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MATCHA_GOTCHA] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Matcha Gotcha", "Cañón Batidor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SYRUP_BOMB] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Syrup Bomb", "Bomba Caramelo"),
        .description = COMPOUND_STRING(
            "Lowers the foe's speed\n"
    ...
    [MOVE_IVY_CUDGEL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Ivy Cudgel", "Garrote Liana"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Electro Shot", "Electrorrayo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TERA_STARSTORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tera Starstorm", "Teraclúster"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FICKLE_BEAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Fickle Beam", "Láser Veleidoso"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Burning Bulwark", "Llama Protectora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDERCLAP] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Thunderclap", "Relámpago Súbito"),
        .description = sSuckerPunchDescription,
        .effect = EFFECT_SUCKER_PUNCH,
        .power = 70,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_MIGHTY_CLEAVE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Mighty Cleave", "Filo Potente"),
        .description = sFeintDescription,
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_ROCK,
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tachyon Cutter", "Tajo Taquión"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HARD_PRESS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hard Press", "Prensa Metálica"),
        .description = sWringOutDescription,
        .effect = EFFECT_POWER_BASED_ON_TARGET_HP,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_DRAGON_CHEER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Dragon Cheer", "Bramido Dragón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ALLURING_VOICE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Alluring Voice", "Cantoencantador"), // Canto Encantador
        .description = COMPOUND_STRING(
    ...
    [MOVE_TEMPER_FLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Temper Flare", "Cólera Ardiente"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SUPERCELL_SLAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Supercell Slam", "Plancha Voltaica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC_NOISE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Psychic Noise", "Psicorruido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_UPPER_HAND] =
    {
        ...
        .name = COMPOUND_LANGUAGE_STRING("Upper Hand", "Palma Rauda"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Malignant Chain", "Cadena Virulenta"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Breakneck Blitz", "Carrera Arrolladora"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("All-Out Pummeling", "Ráfaga Demoledora"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Supersonic Skystrike", "Picado Supersónico"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ACID_DOWNPOUR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Acid Downpour", "Diluvio Corrosivo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TECTONIC_RAGE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Tectonic Rage", "Barrena Telúrica"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Continental Crush", "Aplastamiento Gigalítico"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Savage Spin-Out", "Guadaña Sedosa"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Never-Ending Nightmare", "Presa Espectral"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Corkscrew Crash", "Hélice Trepanadora"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Inferno Overdrive", "Hecatombe Pírica"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_VORTEX] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Hydro Vortex", "Hidrovórtice Abisal"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLOOM_DOOM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Bloom Doom", "Megatón Floral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GIGAVOLT_HAVOC] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Gigavolt Havoc", "Gigavoltio Destructor"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Shattered Psyche", "Disruptor Psíquico"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Subzero Slammer", "Crioaliento Despiadado"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Devastating Drake", "Dracoaliento Devastador"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Black Hole Eclipse", "Agujero Negro Aniquilador"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TWINKLE_TACKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Twinkle Tackle", "Arrumaco Sideral"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CATASTROPIKA] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Catastropika", "Pikavoltio Letal"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("10,000,000 Volt Thunderbolt", "Gigarrayo Fulminante"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Stoked Sparksurfer", "Surfeo Galvánico"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Extreme Evoboost", "Novena Potencia"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Pulverizing Pancake", "Arrojo Intempestivo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Genesis Supernova", "Supernova Original"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Sinister Arrow Raid", "Aluvión de Flechas Sombrías"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Malicious Moonsault", "Hiperplancha Oscura"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Oceanic Operetta", "Sinfonía de la Diva Marina"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Splintered Stormshards", "Tempestad Rocosa"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Let's Snuggle Forever", "Somanta Amistosa"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Clangorous Soulblaze", "Estruendo Implacable"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Guardian of Alola", "Cólera del Guardián"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Searing Sunraze Smash", "Embestida Solar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Menacing Moonraze Maelstrom", "Deflagración Lunar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Light That Burns the Sky", "Fotodestrucción Apocalíptica"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("Soul-Stealing 7-Star Strike", "Constelación Robaalmas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_GUARD] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Guard", "Maxibarriera"),
        .description = sProtectDescription,
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_NORMAL,
    ...
    [MOVE_MAX_FLARE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Flare", "Maxignición"),
        .description = COMPOUND_STRING(
            "Fire Dynamax attack.\n"
    ...
    [MOVE_MAX_FLUTTERBY] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Flutterby", "Maxinsecto"),
        .description = COMPOUND_STRING(
            "Bug Dynamax attack.\n"
    ...
    [MOVE_MAX_LIGHTNING] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Lightning", "Maxitormenta"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_STRIKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Strike", "Maxiataque"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_KNUCKLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Knuckle", "Maxipuño"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_PHANTASM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Phantasm", "Maxiespectro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_HAILSTORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Hailstorm", "Maxihelada"),
        .description = COMPOUND_STRING(
            "Ice Dynamax attack.\n"
    ...
    [MOVE_MAX_OOZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Ooze", "Maxiácido"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_GEYSER] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Geyser", "Maxichorro"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_AIRSTREAM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Airstream", "Maxiciclón"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_STARFALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Starfall", "Maxiestela"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_WYRMWIND] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Wyrmwind", "Maxidraco"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_MINDSTORM] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Mindstorm", "Maxionda"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_ROCKFALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Rockfall", "Maxilito"),
        .description = COMPOUND_STRING(
            "Rock Dynamax attack.\n"
            "Summons a sandstorm."),
        .effect = EFFECT_MAX_MOVE,
    ...
    [MOVE_MAX_QUAKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Quake", "Maxitemblor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_DARKNESS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Darkness", "Maxisombra"),
        .description = COMPOUND_STRING(
            "Dark Dynamax attack.\n"
    ...
    [MOVE_MAX_OVERGROWTH] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Overgrowth", "Maxiflora"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MAX_STEELSPIKE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("Max Steelspike", "Maximetal"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Vine Lash", "Gigalianas"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_WILDFIRE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Wildfire", "Gigallamarada"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Cannonade", "Gigacañonazo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_BEFUDDLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Befuddle", "Gigaestupor"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Volt Crash", "Gigatronada"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Gold Rush", "Gigamonedas"),
        .description = COMPOUND_STRING(
            "G-max Meowth attack.\n"
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Chi Strike", "Gigapuñición"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_TERROR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Terror", "Gigaaparición"),
        .description = COMPOUND_STRING(
            "G-max Gengar attack.\n"
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Foam Burst", "Gigaespuma"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Resonance", "Gigamelodía"),
        .description = COMPOUND_STRING(
            "G-max Lapras attack.\n"
    ...
    [MOVE_G_MAX_CUDDLE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Cuddle", "Gigaternura"),
        .description = COMPOUND_STRING(
            "G-max Eevee attack.\n"
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Replenish", "Gigarreciclaje"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_MALODOR] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Malodor", "Gigapestilencia"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_MELTDOWN] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Meltdown", "Gigafundido"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Drum Solo", "Gigarredoble"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_FIREBALL] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Fireball", "Gigaesfera Ígnea"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Hydrosnipe", "Gigadisparo"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Wind Rage", "Gigahuracán"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_GRAVITAS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Gravitas", "Gigabóveda"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Stonesurge", "Gigatrampa Rocas"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Volcalith", "Gigarroca Ígnea"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_TARTNESS] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Tartness", "Gigacorrosión"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Sweetness", "Giganéctar"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Sandblast", "Gigapolvareda"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Stun Shock", "Gigadescarga"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Centiferno", "Gigacienfuegos"),
        .description = COMPOUND_STRING(
            "G-max Toxtricity attack.\n"
    ...
    [MOVE_G_MAX_SMITE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Smite", "Gigacastigo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_SNOOZE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Snooze", "Gigasopor"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_FINALE] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Finale", "Gigacolofón"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Steelsurge", "Gigatrampa Acero"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Depletion", "Gigadesgaste"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_G_MAX_ONE_BLOW] =
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max One Blow", "Gigagolpe Brusco"),
    ...
    {
        .name = COMPOUND_LANGUAGE_STRING("G-Max Rapid Flow", "Gigagolpe Fluido"),
        .description = sGMaxOneBlowDescription,    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
