...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_GREAT_TUSK] =
    {
        ...
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = LANGUAGE_STRING("Great Tusk", "Colmilargo"),
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = LANGUAGE_STRING("Scream Tail", "Colagrito"),
    ...
    [SPECIES_BRUTE_BONNET] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = LANGUAGE_STRING("Brute Bonnet", "Furioseta"),
    ...
    [SPECIES_FLUTTER_MANE] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = LANGUAGE_STRING("Flutter Mane", "Melenaleteo"),
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = LANGUAGE_STRING("Slither Wing", "Reptalada"),
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = LANGUAGE_STRING("Sandy Shocks", "Pelarena"),
    ...
    [SPECIES_IRON_TREADS] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = LANGUAGE_STRING("Iron Treads", "Ferrodada"),
    ...
    [SPECIES_IRON_BUNDLE] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = LANGUAGE_STRING("Iron Bundle", "Ferrosaco"),
    ...
    [SPECIES_IRON_HANDS] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = LANGUAGE_STRING("Iron Hands", "Ferropalmas"),
    ...
    [SPECIES_IRON_JUGULIS] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = LANGUAGE_STRING("Iron Jugulis", "Ferrocuello"),
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = LANGUAGE_STRING("Iron Moth", "Ferropolilla"),
        .cryId = CRY_IRON_MOTH,
    ...
    [SPECIES_IRON_THORNS] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = LANGUAGE_STRING("Iron Thorns", "Ferropúas"),
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = LANGUAGE_STRING("Iron Valiant", "Ferropaladín"),
    ...
    [SPECIES_WALKING_WAKE] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = LANGUAGE_STRING("Walking Wake", "Ondulagua"),
    ...
    [SPECIES_IRON_LEAVES] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = LANGUAGE_STRING("Iron Leaves", "Ferroverdor"),
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_GOUGING_FIRE] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = LANGUAGE_STRING("Gouging Fire", "Flamariete"),
    ...
    [SPECIES_RAGING_BOLT] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = LANGUAGE_STRING("Raging Bolt", "Electrofuria"),
    ...
    [SPECIES_IRON_BOULDER] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = LANGUAGE_STRING("Iron Boulder", "Ferromole"),
    ...
    [SPECIES_IRON_CROWN] =
    {
        ...
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = LANGUAGE_STRING("Iron Crown", "Ferrotesta"),
