...
static u16 FontFunc_NormalFrlg(struct TextPrinter *);
...
static void DecompressGlyph_NormalFrlg(u16, bool32);
...
static u32 GetGlyphWidth_NormalFrlg(u16, bool32);
...
static const struct GlyphWidthFunc sGlyphWidthFuncs[] =
{
    ...
    { FONT_NORMAL_FRLG,    GetGlyphWidth_NormalFrlg }
};
...
static const struct FontInfo sFontInfos[] =
{
    ...
    [FONT_NORMAL_FRLG] =
    {
        .fontFunction = FontFunc_NormalFrlg,
        .maxLetterWidth = 6,
        .maxLetterHeight = 16,
        .letterSpacing = 0,
        .lineSpacing = 0,
...
static u16 FontFunc_NormalFrlg(struct TextPrinter *textPrinter)
{
    struct TextPrinterSubStruct *subStruct = (struct TextPrinterSubStruct *)(&textPrinter->subStructFields);

    if (subStruct->hasFontIdBeenSet == FALSE)
    {
        subStruct->fontId = FONT_NORMAL_FRLG;
        subStruct->hasFontIdBeenSet = TRUE;
    }
...
static u16 RenderText(struct TextPrinter *textPrinter)
{
    ...
    case RENDER_STATE_HANDLE_CHAR:
        ...
        case FONT_BRAILLE:
            break;
        case FONT_NORMAL_FRLG:
            DecompressGlyph_NormalFrlg(currChar, textPrinter->japanese);
            break;
        }
...
static void DecompressGlyph_NormalFrlg(u16 glyphId, bool32 isJapanese)
{
    const u16 *glyphs;
    ...
    {
        glyphs = gFontLatinFrlgGlyphs + (0x20 * glyphId);
        gCurGlyph.width = gFontLatinFrlgGlyphWidths[glyphId];
...
static u32 GetGlyphWidth_NormalFrlg(u16 glyphId, bool32 isJapanese)
{
    if (isJapanese == TRUE)
        return 8;
    else
        return gFontLatinFrlgGlyphWidths[glyphId];
}
...
static const s8 sNarrowerFontIds[] =
{
    ...
    [FONT_NORMAL_FRLG] = FONT_SMALL_NARROW,
};
